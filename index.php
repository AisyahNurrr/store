...
<div class="shopping-cart">
   ...
   <table>
      ...
      ?>
         <tr>
            ...
            <td>Rp. <?php echo $fetch_cart['price']; ?>000</td>
            <td>
            ...
            <td>Rp. <?php echo $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']); ?>000</td>
            <td><a href="index.php?remove=<?php echo $fetch_cart['id']; ?>" class="delete-btn" onclick="return confirm('remove item from cart?');">hapus</a></td>
         </tr>
      <?php
   ...
   <div class="cart-btn">  
      <a href="#" class="btn <?php echo ($grand_total > 1)?'':'disabled'; ?>">Checkout</a>
   </div>
